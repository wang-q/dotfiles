...
proxychains4 wget -N ftp://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.32-71.0/interproscan-5.32-71.0-64-bit.tar.gz
...
pigz -dc /$HOME/software/interproscan/interproscan-5.32-71.0-64-bit.tar.gz | pv | tar -pxv -f -
